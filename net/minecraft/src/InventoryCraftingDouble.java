...
public class InventoryCraftingDouble extends InventoryCrafting
{
    ...
    public InventoryCraftingDouble(Container par1Container, int par2, int par3)
    {
    ...
    public ItemStack decrStackSize(int par1, int par2)
    {
        if (this.stackList[par1] != null)
        {
            ...
            if (this.stackList[par1].stackSize <= par2)
            {
                ...
                this.stackList[par1] = null;
                ((ContainerWorkbenchDouble)eventHandler).onCraftMatrix2Changed(this);
                return var3;
            }
            else
            {
